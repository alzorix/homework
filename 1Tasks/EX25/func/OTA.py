'''Требуется написать функцию, которая будет принимать на вход число,
 а возвращать список из простых множителей:
...
def OTA(num):
    ...
    return F,Ft
# зачем нам два типа таких. Что за тип ,гд нам нужно число повторений множителя?
